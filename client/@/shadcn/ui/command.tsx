...
>(({ className, ...props }, ref) => (
  <div className="flex items-center border-b px-3" cmdk-input-wrapper="">
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "flex w-full rounded-md bg-transparent border-none focus:shadow-none focus:ring-0 focus:border-none py-3 text-sm outline-hidden placeholder:text-muted-foreground disabled:cursor-not-allowed focus:outline-hidden disabled:opacity-50",
        className
      )}
      {...props}
    />
