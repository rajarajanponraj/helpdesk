  ...
  return (
    <SidebarProvider>
      <main className="relative pt-8 w-full">
        <div className="max-w-(--breakpoint-xl) mx-auto pb-6 px-4 sm:px-6 lg:pb-16 lg:px-8">
              ...
              <aside className="py-6 px-2 lg:col-span-3">
                <nav className="space-y-2">
                  <Link
                    ...
                    aria-current="page"
                  >
                    <Bell className="shrink-0  h-5 w-5 text-foreground" />
                  ...
                  >
                    <KeyRound className="shrink-0  h-5 w-5 text-foreground" />
                  ...
                  >
                    <Flag className="shrink-0  h-5 w-5 text-foreground" />
